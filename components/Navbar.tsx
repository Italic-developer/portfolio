...
function Navbar() {
  return (
    <nav className="flex flex-row justify-between items-center px-3 py-6 pl-5  sticky -top-1">
      ...
      <span className="flex flex-row items-center justify-center-safe font-display opacity-50 text-base mr-10">
        <Dot
          size={48}
          color="#e5092f"
          strokeWidth={3}
          absoluteStrokeWidth
          className="animate-pulse -mr-1.5"
        />
        <span>Online</span>
      </span>
    </nav>
